(() => {
  ...
  var n = {
      ...
      365: (n, e, t) => {
        ...
        s.push([
          n.id,
          `:root {\n  --background-color1: #282a36;\n  --background-color2: #44475a;\n  --buttonBgColor1: #50fa7b;\n  --buttonBgColor2: #f1fa8c;\n  --buttonBgColor3: #bd93f9;\n  --buttonBgColor4: #ffb86c;\n  --buttonBgColor5: #ff79c6;\n}\n\n* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n  color: white;\n  border-radius: 9px;\n  font-family: "Mozilla Headline", sans-serif;\n}\n\nbody {\n  width: 100vw;\n  height: 100vh;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  padding: 30px 20px;\n  background-color: var(--background-color1);\n}\n\n#container {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  display: flex;\n}\n\n.message-box {\n  position: absolute;\n  top: 30px;\n  right: 100px;\n  z-index: 100;\n}\n\n#logo {\n  position: absolute;\n  z-index: 100;\n  top: 20px;\n  right: 20px;\n  width: 50px;\n  height: 50px;\n}\n\n.left-panel {\n  position: relative;\n  width: 30%;\n  background-color: var(--background-color2);\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n\n.left-panel .add-button {\n  position: absolute;\n  top: 2%;\n  left: 10%;\n  border: 3px solid var(--buttonBgColor1);\n  background-color: var(--background-color2);\n  padding: 14px 7px;\n  margin-top: auto;\n  width: 120px;\n  align-self: center;\n}\n\n.project-container {\n  height: 80%;\n  width: 80%;\n  background-color: var(--background-color2);\n  border: 5px solid var(--background-color1);\n  display: flex;\n  flex-direction: column;\n  padding: 20px 16px;\n  gap: 14px;\n}\n\n.project {\n  display: flex;\n  justify-content: space-between;\n  border: 3px solid var(--buttonBgColor1);\n  background-color: var(--background-color2);\n  flex-shrink: 1;\n  overflow: hidden;\n}\n\n.project.active {\n  background-color: var(--buttonBgColor5);\n}\n\n.project.active .delete-button {\n  background-color: var(--buttonBgColor5);\n}\n\n.project .title {\n  padding: 5px;\n  overflow: hidden;\n  flex-grow: 1;\n  font-size: 1.2rem;\n  font-weight: 700;\n}\n\n.project .delete-button {\n  height: 100%;\n  min-width: 20%;\n  border: none;\n  border-radius: 0;\n  border-left: 3px solid var(--buttonBgColor1);\n  background-color: var(--background-color2);\n}\n\n.add-project-form .submit-button {\n  height: 100%;\n  min-width: 20%;\n  border: none;\n  border-left: 3px solid var(--buttonBgColor1);\n  background-color: var(--background-color2);\n  border-radius: 0;\n}\n\n.add-project-form input {\n  background-color: var(--background-color2);\n  display: block;\n  outline: none;\n  border: none;\n  padding: 5px;\n  flex-grow: 1;\n  min-width: 0;\n  font-size: 1.2rem;\n}\n\n.add-project-form {\n  display: none;\n  border: 3px solid var(--buttonBgColor1);\n}\n\n.right-panel {\n  margin-left: 10px;\n  width: 70%;\n  position: relative;\n  background-color: var(--background-color2);\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n\n.todo-container {\n  height: 80%;\n  width: 80%;\n  overflow: hidden;\n  background-color: var(--background-color2);\n  background-image: url(${u});\n  background-size: cover;\n  background-repeat: no-repeat;\n  background-blend-mode: luminosity;\n  border: 5px solid var(--background-color1);\n  display: flex;\n  flex-wrap: wrap;\n  flex-direction: column;\n  gap: 30px;\n  padding: 30px;\n}\n\n.right-panel .add-button {\n  position: absolute;\n  top: 2%;\n  left: 10%;\n  padding: 14px 7px;\n  width: 120px;\n  border: 3px solid var(--buttonBgColor2);\n  background-color: var(--background-color2);\n}\n\n.todo {\n  display: flex;\n  align-items: center;\n  height: 40px;\n}\n\n.todo .checkbox {\n  margin-right: 20px;\n  width: 35px;\n  height: 35px;\n  border-radius: 50%;\n  border: 3px solid var(--buttonBgColor2);\n  background-color: var(--background-color2);\n}\n\n.todo .checkbox.checked {\n  background-color: var(--buttonBgColor5);\n}\n\n.todo .button-container {\n  flex-basis: 100px;\n  margin-left: auto;\n  height: 100%;\n  display: flex;\n}\n\n.todo .content {\n  flex-grow: 1;\n  flex-shrink: 1;\n  display: flex;\n  height: 100%;\n  align-items: center;\n  overflow: hidden;\n  border: 3px solid var(--buttonBgColor2);\n}\n\n.todo .content.checked {\n  background-color: var(--buttonBgColor5);\n}\n\n.todo .content.checked .button-container > button {\n  background-color: var(--buttonBgColor5);\n}\n\n.todo .title {\n  padding: 8px;\n  font-size: 1.2rem;\n  font-weight: 700;\n}\n\n.content .button-container button {\n  border-left: 3px solid var(--buttonBgColor2);\n  background-color: var(--background-color2);\n  border-radius: 0;\n  overflow: hidden;\n}\n\n.button-container button {\n  flex-grow: 1;\n  border: none;\n}\n\nbutton:hover {\n  cursor: pointer;\n}\n\nbutton {\n  font-size: 1rem;\n}\n\n/* add-todo form styles */\n\n.add-todo-form {\n  height: 80%;\n  width: 80%;\n  display: none;\n  flex-direction: column;\n  padding: 20px 16px;\n  gap: 10px;\n  border: 5px solid #282a36;\n}\n\n.add-todo-form > div.input-container {\n  display: flex;\n  flex-direction: column;\n}\n\n.add-todo-form > div.input-container input,\ntextarea,\nselect {\n  padding: 12px 6px;\n  border: 3px solid var(--background-color1);\n  background-color: var(--background-color2);\n  outline: none;\n  font-size: 1rem;\n  flex-grow: 1;\n  margin-top: 10px;\n}\n\n.add-todo-form > div.input-container label {\n  font-size: 1.2rem;\n}\n\ndiv.input-container.description {\n  flex-grow: 2;\n}\n\ntextarea#description {\n  max-width: 100%;\n  height: 100%;\n}\n\n.add-todo-form .button-container {\n  margin-top: auto;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  gap: 24px;\n  height: 50px;\n  padding: 5px;\n  height: 80px;\n}\n\n.add-todo-form .button-container > button {\n  background-color: var(--background-color2);\n  height: 50px;\n  width: 120px;\n  flex-grow: 0;\n}\n\n.add-todo-form .button-container .back-button {\n  border: 3px solid var(--buttonBgColor4);\n}\n\n.add-todo-form .button-container .submit-button {\n  border: 3px solid var(--buttonBgColor3);\n}\n\n.add-todo-form h1 {\n  align-self: center;\n}\n`,
          "",
        ]);
        const p = s;
      },
      ...
      495: (n, e, t) => {
        n.exports = t.p + "3fd6b02e3475bb3e4b15.jpg";
      },
      540: (n) => {
        n.exports = function (n) {
  ...
  const m = t.p + "assets/6d7c12192a84f3508b3e.svg",
    v = t.p + "assets/861a715c8b3f3db45ccd.svg",
    x = document.querySelector("#logo"),
    y = document.querySelector("p.message"),
    k = document.querySelector(".project-container"),
    w = document.querySelector(".left-panel .add-button"),
    C = document.querySelector(".add-project-form"),
    S = document.querySelector(".add-project-form .submit-button"),
    E = document.querySelector(".todo-container"),
    L = document.querySelector(".right-panel .add-button"),
    j = document.querySelector(".add-todo-form"),
    B = document.querySelector(".add-todo-form .submit-button"),
    q = document.querySelector(".add-todo-form .back-button");
  let T,
    M = [],
    A = [
  ...
  function D() {
    ...
    for (let n of T.todos) {
      ...
      e.classList.add("todo"),
        ...
        d.classList.add("edit-button"),
        (c.src = v),
        (l.src = m),
        n.completed && (t.classList.add("checked"), o.classList.add("checked")),
          ...
          (n.completed = !n.completed),
            n.completed
              ? (t.classList.add("checked"),
                ...
                (y.textContent = "Well Done!"))
              : (t.classList.remove("checked"),
                o.classList.remove("checked"),
                (y.textContent = "You Can Do it!"));
        }),
        i.addEventListener("click", () => {
          (T.todos = T.todos.filter((e) => e !== n)), D();
        }),
        d.addEventListener("click", () => {
          (Y = !0),
            ...
            (document.querySelector("input#todo-title").value = n.title),
            (document.querySelector("textarea#description").value =
              n.description),
            (document.querySelector("input#due-date").value = n.dueDate),
            (document.querySelector("select#priority").value = n.priority);
        });
    }
  }
  function I() {
  ...
  setInterval(() => {
    ...
    x.addEventListener("click", () => {
      E.style.backgroundBlendMode =
        "normal" === E.style.backgroundBlendMode ? "luminosity" : "normal";
    }),
    ...
    S.addEventListener("click", (n) => {
      n.preventDefault();
      const e = C.children[0].value;
      var t;
      "" === e
        ? (y.textContent = "You must give it a title!")
        : ((y.textContent = ""),
          (t = e),
          M.push(new P(t)),
          (T = M[M.length - 1]),
          (function (n) {
            ...
            e.classList.add("project"),
              ...
              o.classList.add("delete-button"),
              (r.src = v),
              (t.textContent = n.title),
              o.addEventListener("click", () => {
                confirm("Are you sure?") &&
                  ((y.textContent = "The project is deleted!"),
                  e.remove(),
                  (M = M.filter((e) => e !== n)),
                  (n.todos = []),
                  T === n && (T = null),
                  0 === M.length &&
                    (y.textContent = "Create a project to get started!"));
              }),
              e.addEventListener("click", (t) => {
                t.stopPropagation(),
                  Array.from(k.children)
                    .slice(1)
                    .forEach((n) => {
    ...
    L.addEventListener("click", () => {
      0 !== M.length
        ? ((y.textContent = "Welcome Back!"),
          (j.style.display = "flex"),
          (E.style.display = "none"))
        : (y.textContent = "You must have a project!");
    }),
    B.addEventListener("click", (n) => {
      n.preventDefault();
      const e = document.querySelector("input#todo-title").value,
        t = document.querySelector("textarea#description").value,
        o = document.querySelector("input#due-date").value,
        r = document.querySelector("select#priority").value;
      "" !== e
        ? ((y.textContent = ""),
          Y && z
            ? ((z.title = e),
